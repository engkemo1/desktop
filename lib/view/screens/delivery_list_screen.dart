...
print(productList);
  ...
  buildCardDesktop(ProductCubit data, BuildContext context)   {
    ...
    var productList =   data.productsModelList.where((element) => DateTime.now().difference(DateTime.parse(element.deliveryTime!)).inDays.abs()<=5).toList();
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){
                      ...
                      children: [
                        Text("تأكيد التسليم",style: TextStyle(color: Colors.white),),
